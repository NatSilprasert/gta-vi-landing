...
const Lucia = () => {
  ...
  return (
    <section className="lucia-life">
      <div className="flex flex-col gap-5 items-end img-box lg:w-1/2 ps-10 mt-80">
      ...
      <div className="lg:w-1/2 lucia-life-content">
        <div className="max-w-xl lg:ps-12 ps-10">
          <h1>Lucia Caminos</h1>
        ...
        <p className="max-w-xl lg:ps-12 ps-10 mt-[-40px]">More than anything, Lucia wants the good life her mom has dreamed of since their days in Liberty City — but instead of half-baked fantasies, Lucia is prepared to take matters into her own hands.</p>
      </div>
    </section>
  )
}
